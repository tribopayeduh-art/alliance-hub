    ...
    function(t) {
        var e = function(e) {
            ...
            return __extends(n, e), n.prototype.init = function() {
                ...
                this.game.load.atlas(t.Settings.PRELOADER_ATLAS, "img/" + t.Settings.PRELOADER_ATLAS + ".webp", "img/" + t.Settings.PRELOADER_ATLAS + ".json")
    ...
    function(t) {
        var e = function(e) {
            ...
            return __extends(n, e), n.prototype.preload = function() {
                ...
                this.game.load.atlas(t.Settings.GAME_ATLAS, "img/" + t.Settings.GAME_ATLAS + ".webp", "img/" + t.Settings.GAME_ATLAS + ".json"), this.game.load.atlas(t.Settings.UI_ATLAS, "img/" + t.Settings.UI_ATLAS + ".webp", "img/" + t.Settings.UI_ATLAS + ".json"), this.game.load.atlas(t.Settings.FX_ATLAS, "img/" + t.Settings.FX_ATLAS + ".webp", "img/" + t.Settings.FX_ATLAS + ".json"), this.game.load.image("background1", "img/backgrounds/background1.webp"), /*this.game.load.image("mainMenu", "img/backgrounds/mainMenu.webp"),*/ this.game.load.image("frame", "img/backgrounds/frame.webp"), this.game.load.image("levels", "img/backgrounds/levels.webp"), this.game.device.desktop
                ...
                t.Settings.CURRENT_LEVEL = Math.max(1, t.Settings.LAST_UNLOCKED_LEVEL || 1),
                t.LevelManager.instance.cachedLevel = t.LevelStorage.instance.getLevel(t.Settings.CURRENT_LEVEL),
                t.WindowManager.instance.transitionTo("Level")
